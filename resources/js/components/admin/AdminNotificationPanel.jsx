    ...
    return (
        <section className="rounded-2xl border border-outline-variant/10 bg-surface-container-lowest p-6">
            <div className="mb-6 flex items-center justify-between">
                <div>
                    <h2 className="font-headline text-lg font-bold text-on-surface">Pusat Notifikasi</h2>
                    <p className="mt-1 text-sm text-on-surface-variant">Ringkasan alert operasional terbaru.</p>
                </div>
